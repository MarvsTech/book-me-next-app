  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/this/error" element={<ThisError />} />

        <Route path="*" element={PublicElement(CurrentUserType, "")} />
        <Route path="/" element={PublicElement(CurrentUserType, "blog")} />
        <Route
          path="/login"
          element={PublicElement(CurrentUserType, "login")}
        />
        <Route
          path="/register"
          element={PublicElement(CurrentUserType, "register")}
        />
        ...
        <Route
          path="/admin/doctors"
          element={AdminElement(CurrentUserType, "admin-doctor")}
        />
        <Route
          path="/admin/appointments"
          element={AdminElement(CurrentUserType, "admin-appointment")}
        />
        <Route
          path="/admin/user/logs"
          element={AdminElement(CurrentUserType, "admin-logs")}
        />
        <Route
          path="/admin/settings"
          element={AdminElement(CurrentUserType, "admin-logs")}
        ...
        <Route
          path="/doctor"
          element={DoctorElement(CurrentUserType, "doctor")}
        />
        <Route
        ...
        <Route
          path="/patient"
          element={PatientElement(CurrentUserType, "patient")}
        />
      </Routes>
    </BrowserRouter>
  );
