...
<body>
    ...
    <div class="email-notification-container">
        <div class="email-notification-content">
            ...
            <p class="email-content">We are pleased to confirm that your appointment has been successfully created at Gipili(AkoPaba) Medical Clinic. Below
            ...
            <p class="email-content">Here are your appointment details:</p>
            <div class="email-content email-details">
                <ul>
            ...
            <p class="email-content">Please ensure that you arrive at least 15 minutes before your scheduled appointment time. If you need to reschedule or cancel your appointment, kindly contact us at {{$doctor->contact_number}} or reply to this email at your earliest
            convenience.</p>
            <p class="email-content">We value your time and are committed to providing you with the best medical care possible. If you have any specific concerns or questions you would like to address during your appointment, please feel free to let us know in advance.</p>
            ...
            {{$doctor_schedule_date->date_schedule}}.</p>
