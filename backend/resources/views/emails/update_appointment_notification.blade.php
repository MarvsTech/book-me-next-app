...
<body>
    ...
    <p>We would like to inform you that your appointment has been successfully updated at Gipili(AkoPaba) Medical Clinic. Below are the details of your appointment:</p>
    <p>
    ...
    <p>
        Here is you new appointment details: <br>
