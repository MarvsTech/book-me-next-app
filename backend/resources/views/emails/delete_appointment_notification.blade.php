...
<body>
    ...
    <div class="email-notification-container">
        <div class="email-notification-content">
            ...
            <p class="email-content">We would like to inform you that your appointment has cancelled successfully at Gipili(AkoPaba) Medical Clinic.</p>
            ...
            <p class="email-content">Appointment details:</p>
            <div class="email-content email-details">
                <ul>
